    ...
    <section className="c-space section-spacing">
      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-6 md:auto-rows-[18rem] mt-12">
        ...
        <div className="flex items-end grid-default-color grid-1">
          ...
          />
          <div className="z-10">
            <p className="headtext">Hi, I'm Arshad Alam</p>
            <p className="subtext">
              Over the past few years, I have developed strong frontend and
              backend development skills, enabling me to build dynamic software
        ...
        <div className="grid-default-color grid-2">
          ...
          >
            <p className="text-5xl text-gray-500">CODING IS ART</p>
            <Card
              style={{ rotate: "-10deg", top: "5%", left: "10%" }}
              image="assets/logos/html-5.png"
              containerRef={grid2Container}
            />
            <Card
              style={{ rotate: "15deg", top: "20%", left: "85%" }}
              image="assets/logos/css.png"
              containerRef={grid2Container}
            />
            <Card
              style={{ rotate: "8deg", top: "70%", left: "25%" }}
            ...
            />
            <Card
              style={{ rotate: "30deg", top: "10%", left: "60%" }}
              image="assets/logos/django.png"
              containerRef={grid2Container}
            />
            <Card
              style={{ rotate: "30deg", top: "50%", left: "10%" }}
              image="assets/logos/Git.png"
              containerRef={grid2Container}
            />
            <Card
              style={{ rotate: "30deg", top: "70%", left: "87%" }}
